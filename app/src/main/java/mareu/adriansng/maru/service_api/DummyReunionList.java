...
public class DummyReunionList {
    ...
    public static List<Reunion> DUMMY_REUNION = Arrays.asList(
            new Reunion(0,2, "Henri", "10H00","05/19/2020","pierre@maReu.com, manuel@maReu.com, bran@maReu.com"),
            new Reunion(1, 5, "Bernard", "10H30", "09/02/2020","pierre@maReu.com, manuel@maReu.com, bran@maReu.com"),
            new Reunion(2,8, "Arnaud", "15H00", "01/01/2021","pierre@maReu.com, manuel@maReu.com, bran@maReu.com")
     );
